      ...
      await axios
        ...
        .then(async res => {
          ...
          await axios
            ...
            .catch(err => {
              console.log("kkkkkkkkkkkkk", err.response._response);
            });
        })
        .catch(err => {
          console.log("kkkkkkkkkkkkk", err.response._response);
          ...
          <View>
            ...
            {number == 3 && (
              <>
                ...
                <TextInput
                  multiline={true}
                  numberOfLines={3}
                  placeholder="Une bonne description facilitera de retrouver votre objet "
            ...
            {number == 2 && (
              <>
                ...
                <Label text={TitleDate} isRequired />
                <Button
                ...
                <TextInput
                  multiline={true}
                  numberOfLines={3}
                  placeholder="Une bonne description facilitera de retrouver le document "
                  value={formData.Description}
                  onChangeText={e => {
                    setFormData({ ...formData, Description: e });
                  }}
